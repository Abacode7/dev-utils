...
export const typographyClasses = {
  h1: 'text-4xl font-bold tracking-tight font-display',
  h2: 'text-3xl font-bold tracking-tight font-display',
  h3: 'text-2xl font-semibold tracking-tight font-display',
